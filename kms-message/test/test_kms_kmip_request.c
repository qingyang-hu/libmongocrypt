...
kms_kmip_request_register_secretdata_test (void)
{
   ...
   req = kms_kmip_request_register_secretdata_new (
      NULL, secret_data, sizeof (secret_data), status);
...
#define GET_UNIQUE_IDENTIFIER "7FJYvnV6XkaUCWuY96bCSc6AuhvkPpqI"
...
kms_kmip_get_test (void)
{
   ...
   status = kms_status_new ();
   req = kms_kmip_request_get_new (NULL, GET_UNIQUE_IDENTIFIER, status);
   ASSERT_STATUS_OK (status);
...
#define ACTIVATE_REQUEST                                                      \
   0x42, 0x00, 0x78, 0x01, 0x00, 0x00, 0x00, 0x88, 0x42, 0x00, 0x77, 0x01,    \
      ...
      0x58, 0x6b, 0x61, 0x55, 0x43, 0x57, 0x75, 0x59, 0x39, 0x36, 0x62, 0x43, \
      0x53, 0x63, 0x36, 0x41, 0x75, 0x68, 0x76, 0x6b, 0x50, 0x70, 0x71, 0x49
#define ACTIVATE_UNIQUE_IDENTIFIER "7FJYvnV6XkaUCWuY96bCSc6AuhvkPpqI"
...
kms_kmip_request_activate_test (void)
{
   ...
   status = kms_status_new ();
   req =
      kms_kmip_request_activate_new (NULL, ACTIVATE_UNIQUE_IDENTIFIER, status);
   ASSERT_STATUS_OK (status);
